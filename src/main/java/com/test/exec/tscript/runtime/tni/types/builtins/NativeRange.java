...
public class NativeRange extends NativeFunction {
    ...
    public Data run(TThread caller, LinkedHashMap<String, Data> params) {
        ...
        caller.reportRuntimeError("can not convert " + object + " to Range");
        return null;
    }
