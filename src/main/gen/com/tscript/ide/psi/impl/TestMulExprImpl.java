...
public class TestMulExprImpl extends TestExprImpl implements TestMulExpr {

  public TestMulExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<TestMulOp> getMulOpList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, TestMulOp.class);
  }
