...
public class TestShiftExprImpl extends TestExprImpl implements TestShiftExpr {

  public TestShiftExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<TestShiftOp> getShiftOpList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, TestShiftOp.class);
  }
